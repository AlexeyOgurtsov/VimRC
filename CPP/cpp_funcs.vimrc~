...
:function! GetEnumLiteralLine(BaseArgs, Ops, LineAfter, Name)
	let l:res = a:Name
...
:function! GetLines_EnumLiteral(ShouldAddComma, BaseArgs, Ops, Context, LineAfter, Name)
	let l:lines = []
	"Add Comment
...
:function! CmdFunc_AddCode_EnumClassOrLiteral(...)
	...
	elseif IsEnumLiteralContextType(l:ContextType)
		...
		return AddCode_EnumLiteral(l:BaseArgs, l:Ops, l:Context, l:LiteralLineAfter, l:Name)
	else
